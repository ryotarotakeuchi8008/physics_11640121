...
# 各パラメーター
input_size = 2  # 入力系列の次元
output_size = 2  # 出力系列の次元
batch_size = 20
...
def main():
    ...
    for epoch in range(num_epochs):
        ...
        print("epoch: {}, loss_train: {},loss_valid:{}, acc: {}".format(epoch, round(running_loss_train, 5),

                                                                        round(running_loss_valid, 5), running_acc))
